		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Planning Report",
									"targetURL": "#salesplanningreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salesplanningreport-display": {
								"semanticObject": "salesplanningreport",
								"action": "display",
								"description": "SIMMEL - Report Pianificazione Vendite",
								"title": "Sales Planning Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salesplanningreport",
									"url": sap.ui.require.toUrl("salesplanningreport")
								}
							}
						}
					}
